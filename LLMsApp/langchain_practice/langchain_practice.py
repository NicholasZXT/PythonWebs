...
LangChain v1.0 引入的新的 agent 构建参见 langchain_agents_practice.py。
"""
# %%
import os
import asyncio
...
# ---------- LLM 模型包装器实现类 ----------
# 注意，LangChain-community 已经**于 2026.6.19 存档停止维护**，后续下面的内容转向专用的第三方包集成，而不是都放到 langchain-community 里。
