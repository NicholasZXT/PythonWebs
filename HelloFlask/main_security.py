...
from auth_app.views_security import security, security_bp
"""
单独研究Flask-Security的使用，因为此扩展内部会注册Flask-Login, Flask-Principal等扩展，
可能和 main.py 里自己单独注册的这些扩展实例有冲突，因此单独使用一个Flask应用，并从 auth_app.views_security 引入
"""
...
if __name__ == '__main__':
    ...
    with app.app_context():
        # 必须要导入表定义才能创建
        from auth_app.models import SecurityUser, Role
